...
<?php
								$cat = $itpolly['cat_twenty'];
								if($cat == NULL){ $cat = 1; }else{ $cat = $cat; }
								$cat_how = $itpolly['how_post_twenty'];
...
<?php 
                        ...
                        <div class="col-lg-4 col-md-4"> 
<?php
								$cat = $itpolly['cat_twenty_one'];
								if($cat == NULL){ $cat = 1; }else{ $cat = $cat; }
								$cat_how = $itpolly['how_post_twenty_one'];
								$category_name = get_the_category_by_id($cat);
								$category_name_link = get_category_link($cat); 
							?>
...
<?php 
                         ...
                         <div class="col-lg-4 col-md-4"> 
<?php
								$cat = $itpolly['cat_twenty_two'];
								if($cat == NULL){ $cat = 1; }else{ $cat = $cat; }
								$cat_how = $itpolly['how_post_twenty_two'];
								$category_name = get_the_category_by_id($cat);
								$category_name_link = get_category_link($cat); 
							?>
