 ...
 */
global $itpolly;
$sec_title = $itpolly['sec_title_five'];
?>
 ...
 <section class="section-five">
                <div class="<?php container_itpolly(); ?>">
                    <div class="row">
						...
						<?php
								$cat = $itpolly['cat_seven'];
								if($cat == NULL){ $cat = 1; }else{ $cat = $cat; }
								$cat_how = $itpolly['how_post_seven'];
...
<?php 
                         ...
                         <div class="col-lg-4 col-md-4">
						<?php
								$cat = $itpolly['cat_eight'];
								if($cat == NULL){ $cat = 1; }else{ $cat = $cat; }
								$cat_how = $itpolly['how_post_eight'];
								$category_name = get_the_category_by_id($cat);
								$category_name_link = get_category_link($cat); 
							?>
...
<?php 
                         ...
                         <div class="col-lg-4 col-md-4">
						<?php
								$cat = $itpolly['cat_nine'];
								if($cat == NULL){ $cat = 1; }else{ $cat = $cat; }
								$cat_how = $itpolly['how_post_nine'];
								$category_name = get_the_category_by_id($cat);
								$category_name_link = get_category_link($cat); 
							?>
