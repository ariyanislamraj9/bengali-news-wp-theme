 ...
 */
global $itpolly;
$sec_title = $itpolly['sec_title_nine'];
?>

<section class="section-seven">
                <div class="<?php container_itpolly(); ?>">
				<?php
								$cat = $itpolly['cat_fifteen'];
...
<?php 
								...
								if($video){ ?>
								<a href="<?php the_permalink()?>" class="video-icon6"><i class="la la-play"></i></a>
								<?php }	else{} ?>
                                    ...
                                    <div class="secSeven-details">
                                        <?php echo excerpt($itpolly['excerpt_cat_fifteen']); ?> <a href="<?php the_permalink()?>"> <?php echo $itpolly['details']; ?></a> 
                                    </div>
...
<?php 
								$video = get_post_meta(get_the_ID(),'video', true);
								if($video){ ?>
								<a href="<?php the_permalink()?>" class="video-icon6-2"><i class="la la-play"></i></a>
								<?php }	else{} ?>
