 ...
 */
global $itpolly;
$sec_title = $itpolly['sec_title_seven'];
?>
 ...
 <section class="section-five">
                <div class="<?php container_itpolly(); ?>">
                    <div class="row">
						...
						<?php
								$cat = $itpolly['cat_eleven'];
								if($cat == NULL){ $cat = 1; }else{ $cat = $cat; }
								$cat_how = $itpolly['how_post_eleven'];
...
<?php 
								...
								$video = get_post_meta(get_the_ID(),'video', true);
								if($video){ ?>
								<a href="<?php the_permalink()?>" class="small-icon4"><i class="la la-play"></i></a>
								<?php }	else{} ?>
                         ...
                         <div class="col-lg-4 col-md-4">
						<?php
								$cat = $itpolly['cat_twelve'];
								if($cat == NULL){ $cat = 1; }else{ $cat = $cat; }
								$cat_how = $itpolly['how_post_twelve'];
								$category_name = get_the_category_by_id($cat);
								$category_name_link = get_category_link($cat); 
							?>
...
<?php 
                         ...
                         <div class="col-lg-4 col-md-4">
						<?php
								$cat = $itpolly['cat_thirteen'];
								if($cat == NULL){ $cat = 1; }else{ $cat = $cat; }
								$cat_how = $itpolly['how_post_thirteen'];
								$category_name = get_the_category_by_id($cat);
								$category_name_link = get_category_link($cat); 
							?>
