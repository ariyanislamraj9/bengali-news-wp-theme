  ...
  <section class="section-five">
                <div class="<?php container_itpolly(); ?>">
                    <div class="row">
						...
						<?php
								$cat = $itpolly['cat_sixteen'];
								if($cat == NULL){ $cat = 1; }else{ $cat = $cat; }
								$cat_how = $itpolly['how_post_sixteen'];
...
<?php 
                         ...
                         <div class="col-lg-4 col-md-4">
						<?php
								$cat = $itpolly['cat_seventeen'];
								if($cat == NULL){ $cat = 1; }else{ $cat = $cat; }
								$cat_how = $itpolly['how_post_seventeen'];
								$category_name = get_the_category_by_id($cat);
								$category_name_link = get_category_link($cat); 
							?>
...
<?php 
                         ...
                         <div class="col-lg-4 col-md-4">
						<?php
								$cat = $itpolly['cat_eighteen'];
								if($cat == NULL){ $cat = 1; }else{ $cat = $cat; }
								$cat_how = $itpolly['how_post_eighteen'];
								$category_name = get_the_category_by_id($cat);
								$category_name_link = get_category_link($cat); 
							?>
